...
public class TestSchultyp2 {
	...
	/**
	 * testet ob Ganztagsschule nicht null ist und am ende gibt er uns anzahl, wert,index und text aus
	 * @param schulen
	 */
			...
			if (schulen.get(i).getSchultypen() != null) {
				if (schulen.get(i).getSchultypen().getGanztagsschule()!=null) {
					...
					if (schulen.get(i).getSchultypen().getGanztagsschule().length() > wert) {
						...
						text = schulen.get(i).getSchultypen().getGanztagsschule(); 
					}
				}
			}			
		}
